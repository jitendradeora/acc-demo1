...
const news = [
  ...
  { id: 3, title: 'إصدار العدد الجديد من مجلة "الكلمة": قراءات في الأدب المعاصر', excerpt: 'صدر مؤخراً العدد الجديد من مجلة الكلمة الفصلية التي يصدرها النادي، متضمناً مجموعة من الدراسات النقدية والقصائد والقصص القصيرة لنخبة من الكتاب العرب...', date: '5 فبراير 2026', category: 'إصدارات', image: newsthree },
  { id: 4, title: 'توقيع اتفاقية تعاون مع جامعة الشارقة لدعم البحوث الأدبية', excerpt: 'وقع النادي الثقافي العربي مذكرة تفاهم مع جامعة الشارقة تهدف إلى تعزيز التعاون في مجالات البحث العلمي وتوفير فرص تدريبية لطلاب كلية الآداب...', date: '1 فبراير 2026', category: 'شراكات', image: newsfour },  
