...
const newsData = [
  {
    ...
    content: `
      <p>أعلن النادي الثقافي العربي في الشارقة عن إطلاق الدورة الجديدة من برنامج "المبدع الصغير"، وهو مبادرة استراتيجية تهدف إلى اكتشاف وصقل المواهب الإبداعية لدى الأطفال والناشئة في دولة الإمارات العربية المتحدة.</p>
  ...
  },
  {
    ...
    content: `
      <p>استقبل النادي الثقافي العربي في الشارقة وفداً رسمياً رفيع المستوى يمثل الأمانة العامة لمجلس التعاون لدول الخليج العربية، وذلك في إطار تعزيز التعاون الثقافي المشترك بين المؤسسات الثقافية في المنطقة.</p>
    ...
    <div className="pb-30 pt-30 z-0 relative">
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
            ...
            >
              ...
              <div className="mt-16 p-8 bg-secondary/30 rounded-[2rem] border border-border flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-grow text-center md:text-right">
                  ...
                  <Link to="/authors" className="text-club-blue text-sm font-bold flex items-center justify-center md:justify-start gap-2 hover:gap-3 transition-all">
              ...
              <div>
                ...
                <div className="space-y-6">
                  {relatedNews.map((news) => (
                    <Link key={news.id} to={`/news/${news.id}`} className="group flex gap-4">
        ...
        <div className="mt-24 pt-12 border-t border-border flex justify-between items-center">
          <Link to="/news" className="flex items-center gap-3 text-club-purple font-bold hover:gap-4 transition-all">
            <ArrowRight size={20} />
